              ...
              body: SafeArea(
                child: SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    children: [
                      // Full Rich Teacher Header Row (Avatar, Name/Role, Catatan, Night Mode, Notifikasi)
                      Row(
                        children: [
                          GestureDetector(
                            onTap: () {
                            ...
                            child: Container(
                              ...
                              child: userPhoto.isNotEmpty
                                  ? Image.network(
                                      userPhoto,
                                      fit: BoxFit.cover,
                                      errorBuilder: (_, __, ___) => _buildAvatarFallback(rawName, isDark),
                                    )
                                  : _buildAvatarFallback(rawName, isDark),
                            ),
                          ),
                            ...
                            Expanded(
                              child: TextField(
                                ...
                                decoration: InputDecoration(
                                  hintText: 'Cari classroom, materi, atau monitoring...',
